...
import employmentEndDatePage_content from "../content/employmentEndDatePage_content";
...
class EmploymentEndDatePage {
    ...
    async checkPageLoads(page: Page): Promise<void> {
        await expect(page.locator(this.title)).toContainText(employmentEndDatePage_content.pageTitle);
        await axeTest(page);
    }
